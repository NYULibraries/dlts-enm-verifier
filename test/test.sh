...
test[1]="./ev browsetopicslists --enm-local=test/enm/browsetopicslists --tct-local=test/tct/browsetopicslists"
verify[1]='diff -r --exclude .commit-empty-directory reports/browsetopicslists/ test/reports/browsetopicslists/'

test[2]="./ev solr --enm-local=test/enm/solr --tct-local=test/tct/solr -- ${locationIds}"
verify[2]='diff -r --exclude .commit-empty-directory reports/solr/ test/reports/solr/'

test[3]="./ev topicpages --count-related-topics-occurrences --tct-local=test/tct/topicpages/ --enm-local=test/enm/topicpages/ -- ${topicIds}"
